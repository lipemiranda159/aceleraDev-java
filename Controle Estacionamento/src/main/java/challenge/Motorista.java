...
import challenge.services.ServiceValidaMotorista;
...
public class Motorista {
    ...
    public static class MotoristaBuilder {
        ...
        public MotoristaBuilder withIdade(int idade) {
            ServiceValidaMotorista.ValidaIdadeNegativa(idade);
            this.idade = idade;
            return this;
        }

        public MotoristaBuilder withPontos(int pontos) {
            ServiceValidaMotorista.PontuacaoValida(pontos);
            this.pontos = pontos;
            return this;
        }
        ...
        public Motorista build() {
            ...
            if (ServiceValidaMotorista.ValidaMotorista(motorista)){
                return motorista;
            } else {
                throw new NullPointerException("Motorista Inválido");
            }
        }
    }
}
